...
public:
  ...
  bool putLiveData(float current, bool alert, const char* alertType, int rssi, uint32_t uptimeSec, const char* firmwareVersion, float battVolts = -1.0, float battPercent = -1.0);
